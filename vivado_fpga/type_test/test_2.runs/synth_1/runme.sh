...
HD_PWD='E:/projects/vivado_fpga/test_2/test_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_package.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_package.tcl
